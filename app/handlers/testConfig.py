...
class TestConfigFeatureThread(threading.Thread):
    ...
    def run(self):
        ...
        video.create_video_from_images(images_folder, temp_image_prefix, self.frame_start, videos_folder, video_filename, video.get_framerate(get_project_video_path(self.identifier)))
